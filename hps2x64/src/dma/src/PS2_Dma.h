...
namespace Playstation2
{
	...
	public:
		...
		static u32 Read ( u32 Address, u64 Mask );
		...
		static const u64 c_iSIF0_TransferTime = 1;
		static const u64 c_iSIF1_TransferTime = 0;	//1;
		...
		void DMA5_WriteBlock ( u64 EEDMATag, u64* Data64, u32 QWC_Count );
		...
		inline void ConnectDevices ( u32* _inSBUS_F240 )
		{
