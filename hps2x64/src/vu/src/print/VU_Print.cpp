...
static string Print::PrintInstructionLO ( long instruction )
{
	stringstream ss;
	ss.str("");
...
static string Print::PrintInstructionHI ( long instruction )
{
	stringstream ss;
	ss.str("");
...
static void Print::ABS ( stringstream &strInstString, long instruction )
{
	strInstString << "ABS";
...
static void Print::ADDq ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDQ";
	AddInstArgs ( strInstString, instruction, FTVADDQ );
}

static void Print::ADDBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDBCX";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ADDBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDBCY";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ADDBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDBCZ";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ADDBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::SUBi ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBI";
	AddInstArgs ( strInstString, instruction, FTVSUBI );
}

static void Print::SUBq ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBQ";
	AddInstArgs ( strInstString, instruction, FTVSUBQ );
}

static void Print::SUBBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBBCX";
	AddInstArgs ( strInstString, instruction, FTVSUBBC );
}

static void Print::SUBBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBBCY";
	AddInstArgs ( strInstString, instruction, FTVSUBBC );
}

static void Print::SUBBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBBCZ";
	AddInstArgs ( strInstString, instruction, FTVSUBBC );
}

static void Print::SUBBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MADDi ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDI";
	AddInstArgs ( strInstString, instruction, FTVMADDI );
}

static void Print::MADDq ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDQ";
	AddInstArgs ( strInstString, instruction, FTVMADDQ );
}

static void Print::MADDBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDBCX";
	AddInstArgs ( strInstString, instruction, FTVMADDBC );
}

static void Print::MADDBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDBCY";
	AddInstArgs ( strInstString, instruction, FTVMADDBC );
}

static void Print::MADDBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDBCZ";
	AddInstArgs ( strInstString, instruction, FTVMADDBC );
}

static void Print::MADDBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MSUB ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUB";
	AddInstArgs ( strInstString, instruction, FTVMSUB );
}

static void Print::MSUBi ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBI";
	AddInstArgs ( strInstString, instruction, FTVMSUBI );
}

static void Print::MSUBq ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBQ";
	AddInstArgs ( strInstString, instruction, FTVMSUBQ );
}

static void Print::MSUBBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBBCX";
	AddInstArgs ( strInstString, instruction, FTVMSUBBC );
}

static void Print::MSUBBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBBCY";
	AddInstArgs ( strInstString, instruction, FTVMSUBBC );
}

static void Print::MSUBBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBBCZ";
	AddInstArgs ( strInstString, instruction, FTVMSUBBC );
}

static void Print::MSUBBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MAX ( stringstream &strInstString, long instruction )
{
	strInstString << "MAX";
	AddInstArgs ( strInstString, instruction, FTVMAX );
}

static void Print::MAXi ( stringstream &strInstString, long instruction )
{
	strInstString << "MAXI";
	AddInstArgs ( strInstString, instruction, FTVMAXI );
}

static void Print::MAXBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MAXBCX";
	AddInstArgs ( strInstString, instruction, FTVMAXBC );
}

static void Print::MAXBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MAXBCY";
	AddInstArgs ( strInstString, instruction, FTVMAXBC );
}

static void Print::MAXBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MAXBCZ";
	AddInstArgs ( strInstString, instruction, FTVMAXBC );
}

static void Print::MAXBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MINI ( stringstream &strInstString, long instruction )
{
	strInstString << "MINI";
	AddInstArgs ( strInstString, instruction, FTVMINI );
}

static void Print::MINIi ( stringstream &strInstString, long instruction )
{
	strInstString << "MINII";
	AddInstArgs ( strInstString, instruction, FTVMINII );
}

static void Print::MINIBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MINIBCX";
	AddInstArgs ( strInstString, instruction, FTVMINIBC );
}

static void Print::MINIBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MINIBCY";
	AddInstArgs ( strInstString, instruction, FTVMINIBC );
}

static void Print::MINIBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MINIBCZ";
	AddInstArgs ( strInstString, instruction, FTVMINIBC );
}

static void Print::MINIBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MUL ( stringstream &strInstString, long instruction )
{
	strInstString << "MUL";
	AddInstArgs ( strInstString, instruction, FTVMUL );
}

static void Print::MULi ( stringstream &strInstString, long instruction )
{
	strInstString << "MULI";
	AddInstArgs ( strInstString, instruction, FTVMULI );
}

static void Print::MULq ( stringstream &strInstString, long instruction )
{
	strInstString << "MULQ";
	AddInstArgs ( strInstString, instruction, FTVMULQ );
}

static void Print::MULBCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MULBCX";
	AddInstArgs ( strInstString, instruction, FTVMULBC );
}

static void Print::MULBCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MULBCY";
	AddInstArgs ( strInstString, instruction, FTVMULBC );
}

static void Print::MULBCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MULBCZ";
	AddInstArgs ( strInstString, instruction, FTVMULBC );
}

static void Print::MULBCW ( stringstream &strInstString, long instruction )
{
...
static void Print::ITOF0 ( stringstream &strInstString, long instruction )
{
	strInstString << "ITOF0";
	AddInstArgs ( strInstString, instruction, FTVITOF0 );
}

static void Print::FTOI0 ( stringstream &strInstString, long instruction )
{
	strInstString << "FTOI0";
	AddInstArgs ( strInstString, instruction, FTVFTOI0 );
}

static void Print::ITOF4 ( stringstream &strInstString, long instruction )
{
	strInstString << "ITOF4";
	AddInstArgs ( strInstString, instruction, FTVITOF4 );
}

static void Print::FTOI4 ( stringstream &strInstString, long instruction )
{
	strInstString << "FTOI4";
	AddInstArgs ( strInstString, instruction, FTVFTOI4 );
}

static void Print::ITOF12 ( stringstream &strInstString, long instruction )
{
	strInstString << "ITOF12";
	AddInstArgs ( strInstString, instruction, FTVITOF12 );
}

static void Print::FTOI12 ( stringstream &strInstString, long instruction )
{
	strInstString << "FTOI12";
	AddInstArgs ( strInstString, instruction, FTVFTOI12 );
}

static void Print::ITOF15 ( stringstream &strInstString, long instruction )
{
	strInstString << "ITOF15";
	AddInstArgs ( strInstString, instruction, FTVITOF15 );
}

static void Print::FTOI15 ( stringstream &strInstString, long instruction )
{
...
static void Print::ADDA ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDA";
	AddInstArgs ( strInstString, instruction, FTVADDA );
}

static void Print::ADDAi ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDAI";
	AddInstArgs ( strInstString, instruction, FTVADDAI );
}

static void Print::ADDAq ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDAQ";
	AddInstArgs ( strInstString, instruction, FTVADDAQ );
}

static void Print::ADDABCX ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDABCX";
	AddInstArgs ( strInstString, instruction, FTVADDABC );
}
static void Print::ADDABCY ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDABCY";
	AddInstArgs ( strInstString, instruction, FTVADDABC );
}
static void Print::ADDABCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "ADDABCZ";
	AddInstArgs ( strInstString, instruction, FTVADDABC );
}
static void Print::ADDABCW ( stringstream &strInstString, long instruction )
{
...
static void Print::SUBA ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBA";
	AddInstArgs ( strInstString, instruction, FTVSUBA );
}

static void Print::SUBAi ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBAI";
	AddInstArgs ( strInstString, instruction, FTVSUBAI );
}

static void Print::SUBAq ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBAQ";
	AddInstArgs ( strInstString, instruction, FTVSUBAQ );
}

static void Print::SUBABCX ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBABCX";
	AddInstArgs ( strInstString, instruction, FTVSUBABC );
}
static void Print::SUBABCY ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBABCY";
	AddInstArgs ( strInstString, instruction, FTVSUBABC );
}
static void Print::SUBABCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "SUBABCZ";
	AddInstArgs ( strInstString, instruction, FTVSUBABC );
}
static void Print::SUBABCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MADDA ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDA";
	AddInstArgs ( strInstString, instruction, FTVMADDA );
}

static void Print::MADDAi ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDAI";
	AddInstArgs ( strInstString, instruction, FTVMADDAI );
}

static void Print::MADDAq ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDAQ";
	AddInstArgs ( strInstString, instruction, FTVMADDAQ );
}

static void Print::MADDABCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDABCX";
	AddInstArgs ( strInstString, instruction, FTVMADDABC );
}

static void Print::MADDABCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDABCY";
	AddInstArgs ( strInstString, instruction, FTVMADDABC );
}

static void Print::MADDABCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MADDABCZ";
	AddInstArgs ( strInstString, instruction, FTVMADDABC );
}

static void Print::MADDABCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MSUBA ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBA";
	AddInstArgs ( strInstString, instruction, FTVMSUBA );
}

static void Print::MSUBAi ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBAI";
	AddInstArgs ( strInstString, instruction, FTVMSUBAI );
}

static void Print::MSUBAq ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBAQ";
	AddInstArgs ( strInstString, instruction, FTVMSUBAQ );
}

static void Print::MSUBABCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBABCX";
	AddInstArgs ( strInstString, instruction, FTVMSUBABC );
}

static void Print::MSUBABCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBABCY";
	AddInstArgs ( strInstString, instruction, FTVMSUBABC );
}

static void Print::MSUBABCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MSUBABCZ";
	AddInstArgs ( strInstString, instruction, FTVMSUBABC );
}

static void Print::MSUBABCW ( stringstream &strInstString, long instruction )
{
...
static void Print::MULA ( stringstream &strInstString, long instruction )
{
	strInstString << "MULA";
	AddInstArgs ( strInstString, instruction, FTVMULA );
}

static void Print::MULAi ( stringstream &strInstString, long instruction )
{
	strInstString << "MULAI";
	AddInstArgs ( strInstString, instruction, FTVMULAI );
}

static void Print::MULAq ( stringstream &strInstString, long instruction )
{
	strInstString << "MULAQ";
	AddInstArgs ( strInstString, instruction, FTVMULAQ );
}

static void Print::MULABCX ( stringstream &strInstString, long instruction )
{
	strInstString << "MULABCX";
	AddInstArgs ( strInstString, instruction, FTVMULABC );
}

static void Print::MULABCY ( stringstream &strInstString, long instruction )
{
	strInstString << "MULABCY";
	AddInstArgs ( strInstString, instruction, FTVMULABC );
}

static void Print::MULABCZ ( stringstream &strInstString, long instruction )
{
	strInstString << "MULABCZ";
	AddInstArgs ( strInstString, instruction, FTVMULABC );
}

static void Print::MULABCW ( stringstream &strInstString, long instruction )
{
...
static void Print::CLIP ( stringstream &strInstString, long instruction )
{
	strInstString << "CLIP";
...
static void Print::OPMULA ( stringstream &strInstString, long instruction )
{
	strInstString << "OPMULA";
	AddInstArgs ( strInstString, instruction, FTVOPMULA );
}

static void Print::OPMSUB ( stringstream &strInstString, long instruction )
{
...
static void Print::NOP ( stringstream &strInstString, long instruction )
{
	strInstString << "NOP";
...
static void Print::B ( stringstream &strInstString, long instruction )
{
	strInstString << "B";
	AddInstArgs ( strInstString, instruction, FORMAT43 );
}

static void Print::BAL ( stringstream &strInstString, long instruction )
{
	strInstString << "BAL";
	AddInstArgs ( strInstString, instruction, FORMAT47 );
}

static void Print::IBEQ ( stringstream &strInstString, long instruction )
{
	strInstString << "IBEQ";
	AddInstArgs ( strInstString, instruction, FORMAT45 );
}

static void Print::IBNE ( stringstream &strInstString, long instruction )
{
	strInstString << "IBNE";
	AddInstArgs ( strInstString, instruction, FORMAT45 );
}

static void Print::IBLTZ ( stringstream &strInstString, long instruction )
{
	strInstString << "IBLTZ";
	AddInstArgs ( strInstString, instruction, FORMAT46 );
}

static void Print::IBGTZ ( stringstream &strInstString, long instruction )
{
	strInstString << "IBGTZ";
	AddInstArgs ( strInstString, instruction, FORMAT46 );
}

static void Print::IBLEZ ( stringstream &strInstString, long instruction )
{
	strInstString << "IBLEZ";
	AddInstArgs ( strInstString, instruction, FORMAT46 );
}

static void Print::IBGEZ ( stringstream &strInstString, long instruction )
{
	strInstString << "IBGEZ";
	AddInstArgs ( strInstString, instruction, FORMAT46 );
}
...
static void Print::FCEQ ( stringstream &strInstString, long instruction )
{
	strInstString << "FCEQ";
	AddInstArgs ( strInstString, instruction, FORMAT54 );
}

static void Print::FCAND ( stringstream &strInstString, long instruction )
{
	strInstString << "FCAND";
	AddInstArgs ( strInstString, instruction, FORMAT54 );
}

static void Print::FCOR ( stringstream &strInstString, long instruction )
{
	strInstString << "FCOR";
	AddInstArgs ( strInstString, instruction, FORMAT54 );
}

static void Print::FCGET ( stringstream &strInstString, long instruction )
{
	strInstString << "FCGET";
	AddInstArgs ( strInstString, instruction, FORMAT52 );
}

static void Print::FCSET ( stringstream &strInstString, long instruction )
{
	strInstString << "FCSET";
	AddInstArgs ( strInstString, instruction, FORMAT54 );
}

static void Print::FMEQ ( stringstream &strInstString, long instruction )
{
	strInstString << "FMEQ";
	AddInstArgs ( strInstString, instruction, FORMAT48 );
}

static void Print::FMAND ( stringstream &strInstString, long instruction )
{
	strInstString << "FMAND";
	AddInstArgs ( strInstString, instruction, FORMAT48 );
}

static void Print::FMOR ( stringstream &strInstString, long instruction )
{
	strInstString << "FMOR";
	AddInstArgs ( strInstString, instruction, FORMAT48 );
}

static void Print::FSEQ ( stringstream &strInstString, long instruction )
{
	strInstString << "FSEQ";
	AddInstArgs ( strInstString, instruction, FORMAT56 );
}

static void Print::FSSET ( stringstream &strInstString, long instruction )
{
	strInstString << "FSSET";
	AddInstArgs ( strInstString, instruction, FORMAT55 );
}

static void Print::FSAND ( stringstream &strInstString, long instruction )
{
	strInstString << "FSAND";
	AddInstArgs ( strInstString, instruction, FORMAT56 );
}

static void Print::FSOR ( stringstream &strInstString, long instruction )
{
	strInstString << "FSOR";
	AddInstArgs ( strInstString, instruction, FORMAT56 );
}
...
static void Print::IADD ( stringstream &strInstString, long instruction )
{
	strInstString << "IADD";
	AddInstArgs ( strInstString, instruction, FTVIADD );
}

static void Print::IADDI ( stringstream &strInstString, long instruction )
{
	strInstString << "IADDI";
	AddInstArgs ( strInstString, instruction, FTVIADDI );
}

static void Print::IADDIU ( stringstream &strInstString, long instruction )
{
	strInstString << "IADDIU";
	AddInstArgs ( strInstString, instruction, FORMAT34 );
}

static void Print::ISUB ( stringstream &strInstString, long instruction )
{
	strInstString << "ISUB";
	AddInstArgs ( strInstString, instruction, FTVISUB );
}

static void Print::ISUBIU ( stringstream &strInstString, long instruction )
{
...
static void Print::IAND ( stringstream &strInstString, long instruction )
{
	strInstString << "IAND";
	AddInstArgs ( strInstString, instruction, FTVIAND );
}

static void Print::IOR ( stringstream &strInstString, long instruction )
{
	strInstString << "IOR";
...
static void Print::MFP ( stringstream &strInstString, long instruction )
{
	strInstString << "MFP";
	AddInstArgs ( strInstString, instruction, FORMAT39 );
}

static void Print::MOVE ( stringstream &strInstString, long instruction )
{
	strInstString << "MOVE";
	AddInstArgs ( strInstString, instruction, FTVMOVE );
}

static void Print::MTIR ( stringstream &strInstString, long instruction )
{
	strInstString << "MTIR";
	AddInstArgs ( strInstString, instruction, FTVMTIR );
}

static void Print::MR32 ( stringstream &strInstString, long instruction )
{
	strInstString << "MR32";
	AddInstArgs ( strInstString, instruction, FTVMR32 );
}

static void Print::MFIR ( stringstream &strInstString, long instruction )
{
	strInstString << "MFIR";
...
static void Print::RGET ( stringstream &strInstString, long instruction )
{
	strInstString << "RGET";
	AddInstArgs ( strInstString, instruction, FTVRGET );
}

static void Print::RNEXT ( stringstream &strInstString, long instruction )
{
	strInstString << "RNEXT";
	AddInstArgs ( strInstString, instruction, FTVRNEXT );
}

static void Print::RINIT ( stringstream &strInstString, long instruction )
{
	strInstString << "RINIT";
	AddInstArgs ( strInstString, instruction, FTVRINIT );
}

static void Print::RXOR ( stringstream &strInstString, long instruction )
{
	strInstString << "RXOR";
...
static void Print::SQD ( stringstream &strInstString, long instruction )
{
	strInstString << "SQD";
...
static void Print::SQI ( stringstream &strInstString, long instruction )
{
	strInstString << "SQI";
	AddInstArgs ( strInstString, instruction, FTVSQI );
}

static void Print::LQD ( stringstream &strInstString, long instruction )
{
	strInstString << "LQD";
	AddInstArgs ( strInstString, instruction, FTVLQD );
}

static void Print::LQI ( stringstream &strInstString, long instruction )
{
	strInstString << "LQI";
...
static void Print::ILWR ( stringstream &strInstString, long instruction )
{
	strInstString << "ILWR";
	AddInstArgs ( strInstString, instruction, FTVILWR );
}

static void Print::ISWR ( stringstream &strInstString, long instruction )
{
	strInstString << "ISWR";
	AddInstArgs ( strInstString, instruction, FTVISWR );
}

static void Print::ILW ( stringstream &strInstString, long instruction )
{
	strInstString << "ILW";
	AddInstArgs ( strInstString, instruction, FORMAT44 );
}

static void Print::ISW ( stringstream &strInstString, long instruction )
{
	strInstString << "ISW";
	AddInstArgs ( strInstString, instruction, FORMAT44 );
}
...
static void Print::XGKICK ( stringstream &strInstString, long instruction )
{
...
static void Print::XTOP ( stringstream &strInstString, long instruction )
{
	strInstString << "XTOP";
	AddInstArgs ( strInstString, instruction, FORMAT52 );
}

static void Print::XITOP ( stringstream &strInstString, long instruction )
{
	strInstString << "XITOP";
	AddInstArgs ( strInstString, instruction, FORMAT52 );
}
...
static void Print::WAITP ( stringstream &strInstString, long instruction )
{
	strInstString << "WAITP";
	//AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::WAITQ ( stringstream &strInstString, long instruction )
{
	strInstString << "WAITQ";
...
static void Print::RSQRT ( stringstream &strInstString, long instruction )
{
	strInstString << "RSQRT";
	AddInstArgs ( strInstString, instruction, FTVRSQRT );
}

static void Print::SQRT ( stringstream &strInstString, long instruction )
{
	strInstString << "SQRT";
...
static void Print::EATAN ( stringstream &strInstString, long instruction )
{
	strInstString << "EATAN";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::EATANxy ( stringstream &strInstString, long instruction )
{
	strInstString << "EATANxy";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::EATANxz ( stringstream &strInstString, long instruction )
{
	strInstString << "EATANxz";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ERSQRT ( stringstream &strInstString, long instruction )
{
	strInstString << "ERSQRT";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ERCPR ( stringstream &strInstString, long instruction )
{
	strInstString << "ERCPR";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::EEXP ( stringstream &strInstString, long instruction )
{
	strInstString << "EEXP";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ESIN ( stringstream &strInstString, long instruction )
{
	strInstString << "ESIN";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ESQRT ( stringstream &strInstString, long instruction )
{
	strInstString << "ESQRT";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ESADD ( stringstream &strInstString, long instruction )
{
	strInstString << "ESADD";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}

static void Print::ERSADD ( stringstream &strInstString, long instruction )
{
...
static void Print::ESUM ( stringstream &strInstString, long instruction )
{
	strInstString << "ESUM";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}
...
static void Print::ELENG ( stringstream &strInstString, long instruction )
{
	strInstString << "ELENG";
	AddInstArgs ( strInstString, instruction, FTVADDBC );
}
...
static void Print::ERLENG ( stringstream &strInstString, long instruction )
{
