...
namespace Playstation2
{
	...
	public:
		...
		static void OnClick_Debug_StepPS1_Instr ( u32 i );
		static void OnClick_Debug_StepPS2_Instr ( u32 i );
		static void OnClick_Debug_OutputCurrentSector ( u32 i );
		static void OnClick_Debug_Show_PS2_All ( u32 i );
		static void OnClick_Debug_Show_PS2_FrameBuffer ( u32 i );
		static void OnClick_Debug_Show_R5900 ( u32 i );
		static void OnClick_Debug_Show_PS2_Memory ( u32 i );
		static void OnClick_Debug_Show_PS2_DMA ( u32 i );
		static void OnClick_Debug_Show_PS2_TIMER ( u32 i );
		static void OnClick_Debug_Show_PS2_VU0 ( u32 i );
		static void OnClick_Debug_Show_PS2_VU1 ( u32 i );
		static void OnClick_Debug_Show_PS2_SPU ( u32 i );
		static void OnClick_Debug_Show_PS2_CD ( u32 i );
		static void OnClick_Debug_Show_PS2_INTC ( u32 i );
		...
		static void OnClick_File_Load_GameDisk_PS2CD ( u32 i );
		static void OnClick_File_Load_GameDisk_PS2DVD ( u32 i );
		static void OnClick_File_Load_GameDisk_PS1 ( u32 i );
		...
		static void OnClick_Region_H ( u32 i );
		static void OnClick_Region_R ( u32 i );
		static void OnClick_Region_C ( u32 i );
		static void OnClick_Region_Korea ( u32 i );
