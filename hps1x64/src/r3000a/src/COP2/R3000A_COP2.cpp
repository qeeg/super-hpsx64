...
static const char* COP2_Device::CPC_RegisterNames [ 32 ] = { 
...
static const char* COP2_Device::CPR_RegisterNames [ 32 ] = {
...
static void COP2_Device::Generate_unr_table ()
{
	s64 Temp;
...
void COP2_Device::Start ()
{
	...
	CPC_RegisterPtrs [ 5 ] = &CPC2.TRX;
	CPC_RegisterPtrs [ 6 ] = &CPC2.TRY;
	CPC_RegisterPtrs [ 7 ] = &CPC2.TRZ;
	...
	CPC_RegisterPtrs [ 13 ] = &CPC2.RBK;
	CPC_RegisterPtrs [ 14 ] = &CPC2.GBK;
	CPC_RegisterPtrs [ 15 ] = &CPC2.BBK;
	...
	CPC_RegisterPtrs [ 21 ] = &CPC2.RFC;
	CPC_RegisterPtrs [ 22 ] = &CPC2.GFC;
	CPC_RegisterPtrs [ 23 ] = &CPC2.BFC;
	CPC_RegisterPtrs [ 24 ] = &CPC2.OFX;
	CPC_RegisterPtrs [ 25 ] = &CPC2.OFY;
	...
	CPR_RegisterPtrs [ 8 ] = (s32*)&CPR2.IR0;
	CPR_RegisterPtrs [ 9 ] = (s32*)&CPR2.IR1;
	CPR_RegisterPtrs [ 10 ] = (s32*)&CPR2.IR2;
	CPR_RegisterPtrs [ 11 ] = (s32*)&CPR2.IR3;
	...
	CPR_RegisterPtrs [ 24 ] = &CPR2.MAC0;
	CPR_RegisterPtrs [ 25 ] = &CPR2.MAC1;
	CPR_RegisterPtrs [ 26 ] = &CPR2.MAC2;
	CPR_RegisterPtrs [ 27 ] = &CPR2.MAC3;
	CPR_RegisterPtrs [ 28 ] = &CPR2.IRGB;
	CPR_RegisterPtrs [ 29 ] = &CPR2.ORGB;
	CPR_RegisterPtrs [ 30 ] = &CPR2.LZCS;
...
void COP2_Device::RTPS ( Cpu* r, Instruction::Format i )
{
	...
	//if ( BusyUntil_Cycle > r->CycleCount ) return false;
