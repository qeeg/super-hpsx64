...
{
public:
	static const double c_n_cpuclockspeed = 33868800.0L;
	static const double c_n_mdecbytespersecond = 9000000.0L;	//8000000.0L;
	
	static const double c_n_mdec_cyclesperbyte = 33868800.0L / 9000000.0L;	//8000000.0L;
	...
	void dma_write( UINT32 n_address, INT32 n_size, u32* RAM );
	
	// returns the number of blocks read
	int dma_read( UINT32 n_address, INT32 n_size, u32* RAM/*, INT32 n_decodesize*/ );
...
//private:
	...
	UINT32 mdec_unpack( UINT32 n_address, u32* RAM );
	...
	void mdec_makergb15( UINT32 n_address, INT32 n_r, INT32 n_g, INT32 n_b, INT32 *p_n_y, UINT16 n_stp, u32 XorValue );
	void mdec_makergb24( UINT32 n_address, INT32 n_r, INT32 n_g, INT32 n_b, INT32 *p_n_y, UINT32 n_stp, u32 XorValue );
	...
	INT32 p_n_crblk [ DCTSIZE2 ];
	INT32 p_n_cbblk [ DCTSIZE2 ];
	INT32 p_n_yblk [ DCTSIZE2 * 4 ];
