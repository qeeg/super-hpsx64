...
namespace Playstation1
{
	...
	public:
...
#ifdef PS2_COMPILE
		static const int c_iSIO2_EventCycles_MedCard = 16;	//1024;
		static const int c_iSIO2_EventCycles_FastCard = 16;
		static const int c_iSIO2_EventCycles_SlowCard = 16;	//16384;
		static const int c_iSIO2_EventCycles_Pad = 2048;
		static const int c_iSIO2_EventCycles_MultiTap = 16;
		static const int c_iSIO2_PadPacketSizeMult = 24;
		static const int c_iSIO2_CardPacketSizeMult = 12;
		...
		void DMA_ReadBlock ( u8* Data, int ByteCount );
		void DMA_WriteBlock ( u8* Data, int ByteCount );
		...
		bool SIO2in_DMA_Ready ();
		bool SIO2out_DMA_Ready ();
		...
		static const u32 Key_X_default = 0x4, Key_O_default = 0x2, Key_Triangle_default = 0x1, Key_Square_default = 0x8,
				...
				Key_R1_default = 0x80, Key_R2_default = 0x20, Key_R3_default = 0x800;
		...
		enum { PADTYPE_DIGITAL = 0, PADTYPE_ANALOG };
		...
		static void Create_MemoryCardFile ( char* FileName );
