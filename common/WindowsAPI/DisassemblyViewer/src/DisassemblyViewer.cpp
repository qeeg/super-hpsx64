...
static void Debug_DisassemblyViewer::Event_ListViewUpdate ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i, j, k;
	NMLVDISPINFO *nmlvd;
	LVITEM *lvi;
...
static void Debug_DisassemblyViewer::Dialog_OkClick ( string input )
{
	int i;
	HWND Parent_hWnd;
	u32 Address;
...
static void Debug_DisassemblyViewer::Dialog_CancelClick ( string input )
{
}
