...
static void Debug_MemoryViewer::Event_ListViewUpdate ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i;
	NMLVDISPINFO *nmlvd;
	LVITEM *lvi;
...
static void Debug_MemoryViewer::Dialog_OkClick ( string input )
{
	int i;
	HWND Parent_hWnd;
	u32 Address;
...
static void Debug_MemoryViewer::Dialog_CancelClick ( string input )
{
}
