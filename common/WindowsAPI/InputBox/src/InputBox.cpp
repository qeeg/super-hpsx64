...
static void InputBox::WaitForAllInputBoxes ()
{
...
static int InputBox::FindInputBoxIndex ( HWND hWndInputBox )
{
	int i;
...
static void InputBox::Dialog1_OkClick ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i;
	HWND Parent_hWnd;
...
static void InputBox::Dialog1_CancelClick ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i;
	HWND Parent_hWnd;
