...
bool Debug_BreakpointWindow::Create( WindowClass::Window* ParentWindow, int x, int y, int width, int height )
{
	...
	static const double ColumnWidths_Ratio [] = { 0.05, 0.5, 0.5 };
...
static void Debug_BreakpointWindow::BreakpointWindow_Event ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i, j;
...
static void Debug_BreakpointWindow::BreakPoint_Dialog::Add_Click ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i;
...
static void Debug_BreakpointWindow::BreakPoint_Dialog::Cancel_Click ( HWND hCtrl, int idCtrl, unsigned int message, WPARAM wParam, LPARAM lParam )
{
	int i;
...
static void Debug_BreakpointWindow::BreakPoint_Dialog::DefaultCheckBoxHandler ( HWND hCtrl, int id, unsigned int message, WPARAM wParam, LPARAM lParam )
{
