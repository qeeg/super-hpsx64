...
namespace DiskImage
{
	...
	public:
		...
		volatile s64 ReadIndex, Next_ReadIndex;
		volatile s64 WriteIndex;
		volatile u64 NumberOfSectorsToWrite;
		volatile u8 Buffer [ c_SectorSize * c_BufferSectorCount ];
		volatile u8 SubBuffer [ c_SubChannelSizePerSector * c_BufferSectorCount ];
